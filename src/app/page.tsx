...
export default function Home() {
  return (
    <main className="bg-[#191919] h-fit md:py-0 md:h-screen py-10 flex justify-center pr-[18px]">
      <div className='w-[90%] md:mt-32 mt-8 max-w-[1530px]'>
        <Corner size={250} padding={18} twoCorners className='flex flex-col bg-[#17191a]'>
          ...
          <div className='flex md:p-8 p-0 pt-4 flex-col md:flex-row items-center'>
            <section className='flex flex-col md:pl-12 p-2 md:w-[60%] w-full'>
              <h1 className='text-white text-8xl font-thin text-center md:text-start'>Bem Vindo</h1>
            ...
            <section className='md:ml-20 mt-6'>
